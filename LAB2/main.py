...
# Set Operations
input_set = set(numbers_list)
additional_set = {11, 12}
set_union = input_set.union(additional_set)
set_intersection = input_set.intersection(additional_set)
set_difference = input_set.difference(additional_set)
